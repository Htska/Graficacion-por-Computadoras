...
void Scene::init(){
    ...
    ShaderProgram* m_shaderProgram2 = new ShaderProgram("shaders/normal_vertex.glsl","shaders/normal_frag.glsl");
    ...
    //Model* obj = new CustomModel(m_shaderProgram, "assets/obj/cat.obj", "assets/textures/cat_color.png",ka,kd,ks,3.0f);
    Model* quad1 = new Quad(m_shaderProgram, "assets/textures/brickwall.jpg",ka,kd,ks,1.0f);
    Model* quad = new QuadNormal(m_shaderProgram2, "assets/textures/brickwall.jpg","assets/textures/brickwall_normal.jpg",ka,kd,ks,1.0f);
    m_models.push_back(quad1);
    ...
    m_camera = new OrbitCamera(glm::vec3(0.5f,3.0f,4.0f), glm::vec3(0.0f,0.5f,0.0f), glm::vec3(0.0,1.0,0.0));
    m_view =  m_camera->getMatrix();
    m_light = new Light(glm::vec4(0.0f,2.0f,1.0f,1.0f),glm::vec3(1.0f,1.0f,1.0f),glm::vec3(1.0f,1.0f,1.0f),glm::vec3(1.0f,1.0f,1.0f));
